...
-- Name: Robert Boliske
-- Class: Tech Elevator
-- Abstract: SQL Query National Park Weather Service Capstone
-- ----------------------------------------------------

-- ----------------------------------------------------
-- Options
-- ----------------------------------------------------
USE dbNPGeek			-- get out of Master database
SET NOCOUNT ON				-- report errors only

--- ----------------------------------------------------
-- Drop Tables
-- Example
-- IF OBJECT_ID ( '<table name>' )	IS NOT NULL DROP TABLE <table name>
-- ----------------------------------------------------
IF OBJECT_ID ('weather') IS NOT NULL DROP TABLE weather
IF OBJECT_ID ('survey_result') IS NOT NULL DROP TABLE survey_result
IF OBJECT_ID ('park') IS NOT NULL DROP TABLE park
...
--select * from TWeatherforecasts
--where parkCode = 'CVNP'

--select TParks.parkName, TWeatherForecasts.fiveDayForecastValue, TWeatherForecasts.low, TWeatherForecasts.high, TWeatherForecasts.forecast
--from TWeatherForecasts
--join TParks on TWeatherForecasts.parkCode = TParks.parkCode
--where TParks.parkCode = 'CVNP'